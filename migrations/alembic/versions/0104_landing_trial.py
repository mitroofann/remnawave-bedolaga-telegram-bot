...
'0104' (0104_remnawave_numeric_id) — коллизия с нашим прежним
revision='0104'/down='0103'. Разведено переименованием НАШЕЙ ревизии в
'0104_landing_trial' (файл не переименован намеренно).

NB3 (мерж upstream 4.7.0, 2026-09): апстрим продлил линейку до 0118 и занял
'0107'/'0108'/'0109', коллидировавшие с форковыми expire_squads/bulka/marketing_bots.
Разведено по той же конвенции: форковые ревизии получили суффиксы
(0107_expire_squads, 0108_bulka_sales_flow, 0109_marketing_bots), а весь форк-стек
перецеплен в ХВОСТ: down='0118'. Миграции форка идемпотентны (information_schema) —
повторный прогон на проде безопасен. См. [[alembic-merge-revision-collision]].
"""
